...
public interface ExceptionMessages {
    ...
    String INCORRECT_GREED_CHARACTERS_IN = "grid characters (only X or O) in line ";
    String INCORRECT_GREED_WIDTH_IN = "grid width (all lines must have same width) in line ";
